...
local DeTuThieuLamBK = Scripts[00000100]
...
-- ****************************************************** --
function DeTuThieuLamBK:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuThieuLamBK:OnSelection(scene, npc, player, selectionID)
    ...
    elseif selectionID == 2 then
        Player.OpenShop(npc,player,2280)
        GUI.CloseDialog(player)
...
-- ****************************************************** --
function DeTuThieuLamBK:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
