...
local DeTuThienVuongBK = Scripts[0000078]
...
-- ****************************************************** --
function DeTuThienVuongBK:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuThienVuongBK:OnSelection(scene, npc, player, selectionID)
	...
	elseif selectionID == 2 then
        Player.OpenShop(npc,player,2290)
        GUI.CloseDialog(player)
...
-- ****************************************************** --
function DeTuThienVuongBK:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
