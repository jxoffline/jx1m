...
Global_FactionName = {
	...
	[Global_FactionID.BaDao] = "Bá Đao",
	[Global_FactionID.TieuDao] = "Tiêu Dao",
}
...
Global_NameMapItemPhaiID={
	...
	[91] = {
		ID = 91, Name = "Minh Giáo", PosX = 2600, PosY = 1760 ,FactionID =12, secret1 = 3254, secret2= 3255,press =3875,
	},
	[93] = {
		ID = 93, Name = "Bá Đao", PosX = 3960, PosY = 2300 ,FactionID =16, secret1 = 3254, secret2= 3255,press =3875,
	},
	[95] = {
		ID = 95, Name = "Tiêu Dao", PosX = 4240, PosY = 2100 ,FactionID =15, secret1 = 3254, secret2= 3255,press =3875,
	},
	[97] = {
		ID = 97, Name = "Đoàn Thị", PosX = 4770, PosY = 2380 ,FactionID =13, secret1 = 3254, secret2= 3255,press =3875,
	},
	[99] = {
		ID = 99, Name = "Cổ Mộ", PosX = 4680, PosY = 3300 ,FactionID =14, secret1 = 3254, secret2= 3255,press =3875,
	},
}
...
Global_NameMapPhaiID={
	...
	[91] = {
		ID = 91, Name = "Minh Giáo", PosX = 2600, PosY = 1760
	},
	[93] = {
		ID = 93, Name = "Bá Đao", PosX = 3960, PosY = 2300
	},
