...
local BachCauHoanKyNang = Scripts[200008]
...
-- ****************************************************** --
function BachCauHoanKyNang:OnPreCheckCondition(scene, item, player, otherParams)
...
--		player: Player - NPC tương ứng
-- ****************************************************** --
function BachCauHoanKyNang:OnUse(scene, item, player, otherParams)
...
-- ****************************************************** --
function BachCauHoanKyNang:OnSelection(scene, item, player, selectionID, otherParams)
...
-- ****************************************************** --
function BachCauHoanKyNang:OnItemSelected(scene, item, player, itemID)
