...
local DeTuNguDocBK = Scripts[0000089]
...
-- ****************************************************** --
function DeTuNguDocBK:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuNguDocBK:OnSelection(scene, npc, player, selectionID)

	-- ************************** --
	if selectionID == 1 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,231)
        GUI.CloseDialog(player)
    elseif selectionID == 2 then
        Player.OpenShop(npc,player,2310)
        GUI.CloseDialog(player)
...
-- ****************************************************** --
function DeTuNguDocBK:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
