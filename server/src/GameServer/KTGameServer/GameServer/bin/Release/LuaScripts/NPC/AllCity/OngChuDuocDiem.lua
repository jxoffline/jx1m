...
function OngChuDuocDiem:OnOpen(scene, npc, player)
	...
	-- ************************** --
        ...
        dialog.AddSelection(4,"Thuốc Tinh Linh")
        dialog.AddSelection(5,"Thuốc Tinh Linh(bạc khóa)")
...
function OngChuDuocDiem:OnSelection(scene, npc, player, selectionID)
	...
	elseif selectionID == 2 then
          Player.OpenShop(npc,player,1445)
        GUI.CloseDialog(player)
    elseif selectionID == 4 then
          Player.OpenShop(npc,player,249)
        GUI.CloseDialog(player)
    elseif selectionID == 5 then
          Player.OpenShop(npc,player,248)
        GUI.CloseDialog(player)
