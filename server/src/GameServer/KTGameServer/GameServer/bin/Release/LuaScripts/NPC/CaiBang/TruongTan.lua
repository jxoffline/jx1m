...
local TruongTan = Scripts[0000071]
...
-- ****************************************************** --
function TruongTan:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function TruongTan:OnSelection(scene, npc, player, selectionID)

	-- ************************** --
	if selectionID == 1 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,234)
        GUI.CloseDialog(player)
	elseif selectionID == 2 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,2340)
        GUI.CloseDialog(player)	
...
-- ****************************************************** --
function TruongTan:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
