...
local DeTuConLonBK= Scripts[00000162]
...
-- ****************************************************** --
function DeTuConLonBK:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuConLonBK:OnSelection(scene, npc, player, selectionID)

	-- ************************** --
	if selectionID == 1 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,237)
        GUI.CloseDialog(player)
	elseif selectionID == 2 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,2370)
        GUI.CloseDialog(player)	
...
-- ****************************************************** --
function DeTuConLonBK:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
