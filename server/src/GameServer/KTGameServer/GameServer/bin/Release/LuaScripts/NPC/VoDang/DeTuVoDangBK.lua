...
local DeTuVoDangBK = Scripts[00000127]
...
-- ****************************************************** --
function DeTuVoDangBK:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuVoDangBK:OnSelection(scene, npc, player, selectionID)

	-- ************************** --
	if selectionID == 1 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,236)
        GUI.CloseDialog(player)
	elseif selectionID == 2 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,2360)
        GUI.CloseDialog(player)	
...
-- ****************************************************** --
function DeTuVoDangBK:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
