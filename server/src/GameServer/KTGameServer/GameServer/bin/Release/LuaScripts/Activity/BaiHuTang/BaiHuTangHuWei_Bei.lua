...
local BaiHuTangHuWei_Bei = Scripts[400008]
...
local Details = {
	[43] = {
		...
		EnterScene = {
			SceneID = 47,			-- Bạch Hổ Đường 1_Bắc (sơ)
			PosX = 1449,
			PosY = 821,
		},
	},
	[51] = {
		...
		EnterScene = {
			SceneID = 55,			-- Bạch Hổ Đường 1_Bắc (cao)
			PosX = 1449,
			PosY = 821,
		},
	},
...
-- ****************************************************** --
function BaiHuTangHuWei_Bei:OnOpen(scene, npc, player, otherParams)
	...
	if EventManager.IsBaiHuTangRegisterTime() == false then
		...
		dialog:AddSelection(1, "Tiến vào <color=yellow>Bạch Hổ Đường - Bắc</color>")
	end
...
-- ****************************************************** --
function BaiHuTangHuWei_Bei:OnSelection(scene, npc, player, selectionID, otherParams)
...
-- ****************************************************** --
function BaiHuTangHuWei_Bei:OnItemSelected(scene, npc, player, itemID, otherParams)
...
-- ======================================================= --
-- ======================================================= --
function BaiHuTangHuWei_Bei:ShowDialog(npc, player, text)
