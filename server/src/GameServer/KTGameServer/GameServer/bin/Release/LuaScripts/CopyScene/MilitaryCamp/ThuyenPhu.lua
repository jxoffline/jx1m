...
local ThuyenPhu = Scripts[500102]
...
function ThuyenPhu:OnOpen(scene, npc, player)
	...
	-- ************************** --
        ...
        dialog.AddText("Chẳng hay nhà ngươi đến nơi đây để tu luyện? Lão già này cũng từng gặp rất nhiều người như ngươi nhưng không một ai ra khỏi đây mà còn toàn vẹn cả, hy vọng nhà ngươi là người đầu tiên.")
