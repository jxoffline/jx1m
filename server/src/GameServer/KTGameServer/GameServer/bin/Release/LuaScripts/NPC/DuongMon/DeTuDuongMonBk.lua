...
local DeTuDuongMonBk = Scripts[00000174]
...
-- ****************************************************** --
function DeTuDuongMonBk:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuDuongMonBk:OnSelection(scene, npc, player, selectionID)

	-- ************************** --
	if selectionID == 1 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,230)
        GUI.CloseDialog(player)
    elseif selectionID == 2 then
        Player.OpenShop(npc,player,2300)
        GUI.CloseDialog(player)
...
-- ****************************************************** --
function DeTuDuongMonBk:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
