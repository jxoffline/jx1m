...
namespace GameServer.KiemThe.Logic
{
	...
	public partial class KTMonsterStoryBoardEx
	{
        ...
        private void StartStoryBoard(MonsterStoryBoard storyBoard)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="storyBoard"></param>
        private void TickStoryBoard(MonsterStoryBoard storyBoard, long additionTick = 0, bool autoRemoveUnusedStoryBoard = true)
        {
			try
			{
        ...
        private void StopStoryBoard(MonsterStoryBoard storyBoard)
        {
            try
            {
