...
namespace GameServer.KiemThe.Logic
{
    ...
    public partial class KTBotStoryBoardEx
    {
        ...
        private void StartStoryBoard(OtherStoryBoard storyBoard)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="storyBoard"></param>
        private void TickStoryBoard(OtherStoryBoard storyBoard, long additionTick = 0, bool autoRemoveUnusedStoryBoard = true)
        {
            try
            {
        ...
        private void StopStoryBoard(OtherStoryBoard storyBoard)
        {
            try
            {
