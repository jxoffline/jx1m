...
namespace GameServer.KiemThe.GameEvents.BaiHuTang
{
    ...
    public class BaiHuTang_Script_Round2 : GameMapEvent
    {
		...
		public override bool OnPlayerClickReliveButton(KPlayer player)
        {
            ...
            KTPlayerManager.Relive(player, BaiHuTang.Round2.OutMaps[this.Map.MapCode].OutMapID, BaiHuTang.Round2.OutMaps[this.Map.MapCode].OutPosX, BaiHuTang.Round2.OutMaps[this.Map.MapCode].OutPosY, 100, 100, 100);
            return true;
        }
        #endregion
        ...
        private void CreateBoss()
        {
            ...
            {
                MapCode = this.Map.MapCode,
                ResID = BaiHuTang.Round2.Boss.IDByActivity[this.Activity.Data.ID],
                PosX = randomPos.Key,
                PosY = randomPos.Value,
                Name = BaiHuTang.Round2.Boss.Name,
                Title = BaiHuTang.Round2.Boss.Title,
                MaxHP = hp,
                Level = this.Level,
                MonsterType = (MonsterAIType) BaiHuTang.Round2.Boss.AIType,
                AIID = BaiHuTang.Round2.Boss.AIScriptID,
                Camp = 65535,
            });
        ...
        {
            KDynamicArea teleport = KTDynamicAreaManager.Add(this.Map.MapCode, -1, BaiHuTang.Round2.Teleport.Name, BaiHuTang.Round2.Teleport.ResID, BaiHuTang.Round2.Teleport.PosX, BaiHuTang.Round2.Teleport.PosY, -1, 2000, BaiHuTang.Round2.Teleport.Radius, -1, null);
        ...
        private void TeleportMovePlayerToNextStage(KPlayer player)
        {
            ...
            KTPlayerManager.ChangeMap(player, BaiHuTang.Round2.NextMaps[this.Map.MapCode].NextMapID, posX, posY);
        }
        ...
        {
            KTPlayerManager.ChangeMap(player, BaiHuTang.Round2.OutMaps[this.Map.MapCode].OutMapID, BaiHuTang.Round2.OutMaps[this.Map.MapCode].OutPosX, BaiHuTang.Round2.OutMaps[this.Map.MapCode].OutPosY);
        }
