...
namespace MILogin
{
    public class MUJson
    {
        ...
        public static string getLastErrorSnippet()
        {
            ...
            else
            {
                ...
                return MUJson.lastDecode.Substring(startIndex, endIndex - startIndex + 1);
            }
        }
        ...
        protected static Hashtable parseObject(char[] json, ref int index)
        {
            ...
            while (!done)
            {
                ...
                if (token == MUJson.TOKEN_NONE)
                {
                    return null;
                }
                else if (token == MUJson.TOKEN_COMMA)
                {
                    nextToken(json, ref index);
                }
                else if (token == MUJson.TOKEN_CURLY_CLOSE)
                {
                    nextToken(json, ref index);
                    return table;
                }
        ...
        protected static ArrayList parseArray(char[] json, ref int index)
        {
            ...
            while (!done)
            {
                ...
                else if (token == MUJson.TOKEN_SQUARED_CLOSE)
                {
                    nextToken(json, ref index);
                    break;
                }
        ...
        protected static object parseValue(char[] json, ref int index, ref bool success)
        {
            ...
            {
                case MUJson.TOKEN_STRING:
                    return parseString(json, ref index);
                case MUJson.TOKEN_NUMBER:
                    return parseNumber(json, ref index);
                case MUJson.TOKEN_CURLY_OPEN:
                    return parseObject(json, ref index);
                case MUJson.TOKEN_SQUARED_OPEN:
                    return parseArray(json, ref index);
                case MUJson.TOKEN_TRUE:
                    nextToken(json, ref index);
                    return Boolean.Parse("TRUE");
                case MUJson.TOKEN_FALSE:
                    nextToken(json, ref index);
                    return Boolean.Parse("FALSE");
                case MUJson.TOKEN_NULL:
                    nextToken(json, ref index);
                    return null;
                case MUJson.TOKEN_NONE:
                    break;
            }
    ...
    */
        ...
        protected static int nextToken(char[] json, ref int index)
        {
            ...
            {
                case '{':
                    return MUJson.TOKEN_CURLY_OPEN;
                case '}':
                    return MUJson.TOKEN_CURLY_CLOSE;
                case '[':
                    return MUJson.TOKEN_SQUARED_OPEN;
                case ']':
                    return MUJson.TOKEN_SQUARED_CLOSE;
                case ',':
                    return MUJson.TOKEN_COMMA;
                case '"':
                    return MUJson.TOKEN_STRING;
                case '0':
                case '1':
                case '2':
                case '3':
                ...
                case '9':
                case '-':
                    return MUJson.TOKEN_NUMBER;
                case ':':
                    return MUJson.TOKEN_COLON;
            }
            index--;
