...
{
    public partial class GetServerListTest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                List<ServerListsIo> list2 = kiemTheDbEntities.ServerListsIos.Where(x => x.isTestServer == 5).ToList();

                foreach (ServerListsIo serverList in list2)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        if (flag3)
                        {
                            lastServerLogin = new BuffServerInfo
                            {
                                ...
                                Msg = serverList2.strMaintainTxt,
