...
{
    public partial class GetServerList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			int UserId = int.Parse(text.Split('_')[0]);
			...
			{
				List<ServerList> list2 = kiemTheDbEntities.ServerLists.Where(x=>x.isTestServer==3).ToList();
