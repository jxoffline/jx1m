...
local BaiHuTangHuWei_Nan = Scripts[400010]
...
local Details = {
	[43] = {
		...
		EnterScene = {
			SceneID = 46,			-- Bạch Hổ Đường 1_Nam (sơ)
			PosX = 1449,
			PosY = 821,
		},
	},
	[51] = {
		...
		EnterScene = {
			SceneID = 54,			-- Bạch Hổ Đường 1_Nam (cao)
			PosX = 1449,
			PosY = 821,
		},
	},
...
-- ****************************************************** --
function BaiHuTangHuWei_Nan:OnOpen(scene, npc, player, otherParams)
	...
	if EventManager.IsBaiHuTangRegisterTime() == false then
		...
		dialog:AddSelection(1, "Tiến vào <color=yellow>Bạch Hổ Đường - Nam</color>")
	end
...
-- ****************************************************** --
function BaiHuTangHuWei_Nan:OnSelection(scene, npc, player, selectionID, otherParams)
...
-- ****************************************************** --
function BaiHuTangHuWei_Nan:OnItemSelected(scene, npc, player, itemID, otherParams)
...
-- ======================================================= --
-- ======================================================= --
function BaiHuTangHuWei_Nan:ShowDialog(npc, player, text)
