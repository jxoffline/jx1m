...
local DeTuNgaMyBK = Scripts[00000110]
...
-- ****************************************************** --
function DeTuNgaMyBK:OnOpen(scene, npc, player)
...
-- ****************************************************** --
function DeTuNgaMyBK:OnSelection(scene, npc, player, selectionID)

	-- ************************** --
	if selectionID == 1 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,232)
        GUI.CloseDialog(player)
	elseif selectionID == 2 then
        local dialog = GUI.CreateNPCDialog()
        Player.OpenShop(npc,player,2320)
        GUI.CloseDialog(player)	
...
-- ****************************************************** --
function DeTuNgaMyBK:OnItemSelected(scene, npc, player, selectedItemInfo, otherParams)
