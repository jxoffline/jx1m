...
namespace FS.VLTK.UI.Main.ItemBox
{
    /// <summary>
    /// Ô chứa vật phẩm
    /// </summary>
    public class UIItemBox : MonoBehaviour
    {
        ...
        private void DoRefresh()
        {
            ...
            {
                /// Load icon mặc định
                this.UIImage_ItemIcon.SpriteName = KTGlobal.UnknownItemIcon;
                this.UIImage_ItemIcon.BundleDir = KTGlobal.UnknowItemBundleDir;
                this.UIImage_ItemIcon.AtlasName = KTGlobal.UnknownItemAtlas;
                this.UIImage_ItemIcon.Load();
            }
            /// Nếu là trang bị
            if (itemData.IsEquip)
