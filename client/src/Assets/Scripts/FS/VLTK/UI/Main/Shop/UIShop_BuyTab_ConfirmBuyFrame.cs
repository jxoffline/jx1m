...
{
    /// <summary>
    /// Khung xác nhận mua ở Tab mua
    /// </summary>
    public class UIShop_BuyTab_ConfirmBuyFrame : MonoBehaviour
    {
        #region Define
        /// <summary>
        /// Button đóng khung
        ...
        /// </summary>
        public Action<ShopItem, int> ConfirmBuy { get; set; }
        ...
        private void ButtonBuy_Clicked()
        {
            ...
            this.ConfirmBuy?.Invoke(this.Data, count);
            /// Đóng khung
