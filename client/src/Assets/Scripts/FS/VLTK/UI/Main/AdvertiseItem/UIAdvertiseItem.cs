...
{
    /// <summary>
    /// Khung quảng bá vật phẩm
    /// </summary>
    public class UIAdvertiseItem : MonoBehaviour
    {
        #region Define
        /// <summary>
        /// Button đóng khung
        ...
        /// <summary>
        /// Thông tin vật phẩm được quảng bá
        /// </summary>
        public GoodsData ItemGD
        {
            get
            {
        ...
        private void ButtonSend_Clicked()
        {
            ...
            {
                KTGlobal.AddNotification("Gửi tin nhắn quảng bá vật phẩm thành công!");
