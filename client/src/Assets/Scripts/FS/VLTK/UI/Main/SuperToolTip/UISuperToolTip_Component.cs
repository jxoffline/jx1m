...
using static FS.VLTK.UI.Main.UISuperToolTip;

namespace FS.VLTK.UI.Main.SuperToolTip
{
    /// <summary>
    ...
    public class UISuperToolTip_Component : MonoBehaviour
    {
        ...
        public void Build()
        {
            ...
            {
                /// Load icon mặc định
                this.UIItemBox_Icon.SpriteName = KTGlobal.UnknownItemIcon;
                this.UIItemBox_Icon.BundleDir = KTGlobal.UnknowItemBundleDir;
                this.UIItemBox_Icon.AtlasName = KTGlobal.UnknownItemAtlas;
                this.UIItemBox_Icon.Load();
            }
        }
        #endregion
