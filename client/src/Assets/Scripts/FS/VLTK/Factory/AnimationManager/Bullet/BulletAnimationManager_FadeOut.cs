...
namespace FS.VLTK.Factory.AnimationManager
{
	...
	{
        /// <summary>
        /// Trả về danh sách ảnh động tác tan tương ứng
        /// </summary>
        /// <param name="resID"></param>
        /// <returns></returns>
        public Dictionary<string, UnityEngine.Object> GetFadeOutSprites(int resID)
        {
        ...
        /// <returns></returns>
        public IEnumerator LoadFadeOutSprites(int resID, Action callbackIfNeedToLoad = null)
        {
            /// Thông tin Res
            BulletActionSetXML actionSetXML = Loader.Loader.BulletActionSetXML;
        ...
        /// </summary>
        /// <param name="resID"></param>
        public void UnloadFadeOutSprites(int resID)
        {
            /// Thông tin Res
            BulletActionSetXML actionSetXML = Loader.Loader.BulletActionSetXML;
