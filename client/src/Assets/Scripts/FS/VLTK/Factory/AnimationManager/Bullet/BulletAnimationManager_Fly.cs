...
namespace FS.VLTK.Factory.AnimationManager
{
	...
	public partial class BulletAnimationManager
	{
        ...
        /// <returns></returns>
        public Dictionary<string, UnityEngine.Object> GetFlySprites(int resID)
        {
        ...
        /// <returns></returns>
        public IEnumerator LoadFlySprites(int resID, Action callbackIfNeedToLoad = null)
        {
            /// Thông tin Res
            BulletActionSetXML actionSetXML = Loader.Loader.BulletActionSetXML;
        ...
        /// </summary>
        /// <param name="resID"></param>
        public void UnloadFlySprites(int resID)
        {
            /// Thông tin Res
            BulletActionSetXML actionSetXML = Loader.Loader.BulletActionSetXML;
